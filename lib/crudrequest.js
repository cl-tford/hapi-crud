...
var defaultMethods = {
  ...
  unsuccessfulResponse : function(errors) {
    return errors;
  }
}
...
var CrudRequest = function(options) {
  ...
  this.successfulResponse = options.successfulResponse || defaultMethods.successfulResponse;
  this._errors = [];
};
...
_.extend(CrudRequest.prototype, {
  ...
  _handleUserError : function(errors) {
    ...
    self._replyCallback(self.unsuccessfulResponse(errors))
      .code(400);
  },
  ...
  _handleSuccess : function(data) {
    ...
    self._replyCallback(self.successfulResponse(data))
      .code(200);
  }
